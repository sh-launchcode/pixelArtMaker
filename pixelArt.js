...
box.setAttribute("style", "border:3px solid #000000; width:442px; height:457px; line-height: 0%;");
document.body.appendChild(box);
let divs = document.createElement("div");
divs.setAttribute("style", "margin: 0px 0px 0px 0px; padding: 0px 0px 0px 0px; display:inline-block; border:.1px solid black; width:10px; height:10px;");
let amtPixels = 1444;
...
function turnColor(id){
    ...
    xd.setAttribute("style", "background-color:" + currentColor + "; display:inline-block; border:.1px solid black;; width:10px; height:10px;");
}
